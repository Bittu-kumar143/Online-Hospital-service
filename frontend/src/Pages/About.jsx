                        ...
                        <div class="col-lg-6 col-md-10">
                            <div class="about-caption mb-50">
                                ...
                                <div class="about-btn1 mb-30">
                                    <a href="/About/" class="btn about-btn">Find Doctors .<i class="ti-arrow-right"></i></a>
                                </div>
                                <div class="about-btn1 mb-30">
                                    <a href="/About/" class="btn about-btn2">Appointment <i class="ti-arrow-right"></i></a>
                                </div>
                                <div class="about-btn1 mb-30">
                                    <a href="/About/" class="btn about-btn2">Emargency 1 <i class="ti-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="single-gallery mb-30">
                                <div class="gallery-img small-img" style={{backgroundImage: "url(/assets/img/gallery/gallery5.png)"}}></div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="single-gallery mb-30">
                                <div class="gallery-img big-img" style={{backgroundImage: "url(/assets/img/gallery/gallery6.png)"}}></div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-fluid p-0">
            <div class="row no-gutters">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6">
                    <div class="gallery-box">
                        <div class="single-gallery">
                             <div class="gallery-img " style={{backgroundImage: "url(/assets/img/gallery/gallery5.png)"}}></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6">
                    <div class="gallery-box">
                        <div class="single-gallery">
                            <div class="gallery-img " style={{backgroundImage: "url(/assets/img/gallery/gallery6.png)"}}></div>
                        </div>
                    </div>
                </div>
            </div>
